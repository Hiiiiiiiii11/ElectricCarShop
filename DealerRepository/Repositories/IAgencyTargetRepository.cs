...
namespace AgencyRepository.Repositories
{
    ...
    {
        Task<IEnumerable<AgencyTargets>> GetAgencyTargetsByAgencyId(int AgencyId);
        Task<IEnumerable<AgencyTargets>> GetByAgencyAndPeriodAsync(int AgencyId, int year, int month);
